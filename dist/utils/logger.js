...
const logger = winston_1.default.createLogger({
    ...
    format: winston_1.default.format.combine(enumerateErrorFormat(), winston_1.default.format.timestamp({ format: 'YYYY-MM-DD HH:mm:ss' }), winston_1.default.format.splat(), winston_1.default.format.printf(({ timestamp, level, message, ...meta }) => {
    ...
    transports: [
        new winston_1.default.transports.Console({
            ...
            process.env.NODE_ENV === 'development'
                ...
                : winston_1.default.format.uncolorize(), winston_1.default.format.printf(({ level, message, ...meta }) => {
